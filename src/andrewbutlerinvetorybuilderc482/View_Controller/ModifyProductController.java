...
import static andrewbutlerinvetorybuilderc482.View_Controller.InventoryViewController.selectedProductToModify;
...
public class ModifyProductController implements Initializable {
    ...
    @FXML
    private AnchorPane modifyProductView;
    @FXML
    ...
    private Product product = selectedProductToModify;
    private int index;
    ...
    public void saveButtonPressed(ActionEvent event) throws IOException {
        ...
        if (Integer.parseInt(minField.getText()) > Integer.parseInt(maxField.getText())) {
            ...
            alert.showAndWait();
            maxField.setText(Integer.toString(selectedProductToModify.getMax()));
        }
        if ((Integer.parseInt(inventoryField.getText()) > Integer.parseInt(maxField.getText()))
            ...
            alert.showAndWait();
            inventoryField.setText(Integer.toString(selectedProductToModify.getStock()));
        }
        product.setId(inventory.getProductsAdded());
    ...
    public void initialize(URL url, ResourceBundle rb) {
        product = new Product(selectedProductToModify.getId(),
                selectedProductToModify.getName(), selectedProductToModify.getPrice(),
                selectedProductToModify.getStock(), selectedProductToModify.getMin(), 
                selectedProductToModify.getMax());
        for(Part item : selectedProductToModify.getAllAssociatedParts()){
            product.addAssociatedPart(item);
        }
        this.index = inventory.getAllProducts().indexOf(selectedProductToModify);
        this.idField.setText(Integer.toString(product.getId()));
        this.nameField.setText(product.getName());
        this.inventoryField.setText(Integer.toString(product.getStock()));
        this.priceField.setText(String.format("%.2f", product.getPrice()));
